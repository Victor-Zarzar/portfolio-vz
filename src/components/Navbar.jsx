...
const Navbar = () => {
  return (
    <div className="flex">
      <div className="navbar flex flex-grow text-white sm:h-20 md:h-20 lg:h-20 xl:h-20 items-center bg-black">
        <div className="flex items-center justify-between w-full px-6">
          ...
          <ul className="text-navbar flex space-x-6">
            <div className="flex items-center">
              ...
              <li className="sm:text-[11px] md:text-xs lg:text-lg hover:text-gray-400">
