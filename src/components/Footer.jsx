        ...
        <div className="font-fira mt-10 bg-neutral-800 p-8 pb-20 sm:pb-8">
            <footer className="mx-auto flex flex-col sm:max-w-4xl sm:flex-row sm:justify-between">
                ...
                <div className="flex sm:justify-center space-x-6">
                    ...
                    <div href="https://www.instagram.com/victorzarzar7" target="_blank" className="text-white hover:text-gray-400" rel="noreferrer">
                        <svg className="sm:mr-1 md:mr-1 lg:mr-1 sm:w-3 md:w-4 lg:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fillRule="evenodd"
                    ...
                    <div href="#" target="_blank" className="text-white hover:text-gray-400">
                        <svg className="sm:mr-1 md:mr-1 lg:mr-1 sm:w-3 md:w-4 lg:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path
                    ...
                    <div href="https://github.com/Victor-Zarzar" target="_blank" className="text-white hover:text-gray-400" rel="noreferrer">
                        <svg className="sm:mr-1 md:mr-1 lg:mr-1 sm:w-3 md:w-4 lg:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fillRule="evenodd"
