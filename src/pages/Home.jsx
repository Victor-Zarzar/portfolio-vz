      ...
      <div className="py-8 z-10 font-serif mt-5">
        <div className="flex flex-col md:flex-row items-center max-w-6xl px-6 py-8 mx-auto">
          ...
          <div className="w-full md:w-1/2 py-8 text-right">
            <img src={itdeveloper} alt="itdeveloper" className="md:h-40 lg:h-60 md:mt-0 lg:mt-0 xl:mt-0 2xl:mt-1 inline-block" />
          </div>
        </div>
              ...
              <div className="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col">
                <div className="pattern-dots-md gray-light">
                  <div className="rounded-2xl bg-gray-800 p-4 transform translate-x-6 -translate-y-6">
                    ...
                    <div className="flex-grow md:h-60 md:w-40 lg:h-60 lg:w-40">
        ...
        <div className="mx-auto mt-20 text-center text-white items-center">
          <ul className="flex justify-center mt-5 space-x-5">
            <li>
              <a href="https://facebook.com/victorzarzar58" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
            ...
            <li>
              <a href="https://instagram.com/victorzarzar7" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                <svg className="h-12 w-12" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd"
            ...
            <li>
              <a href="https://www.linkedin.com/in/victorzarzar" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400" aria-label="Visit TrendyMinds LinkedIn"><svg
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-12 w-12">
            ...
            <li>
              <a href="https://github.com/Victor-Zarzar" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                <svg className="h-12 w-12" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd"
