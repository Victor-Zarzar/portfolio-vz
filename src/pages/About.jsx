      ...
      <div className="rounded-lg p-6 mt-20">
        ...
        <div className="flex">
          <div className="flex items-center mx-auto mt-10">
            ...
            <Link to="https://udemy-certificate.s3.amazonaws.com/pdf/UC-6f719ab9-4c08-4a91-8b85-f4a2a698d472.pdf" target="_blank">
        ...
        <div className="flex">
          <div className="flex items-center mx-auto mt-10">
            ...
            <Link to="https://udemy-certificate.s3.amazonaws.com/pdf/UC-36a57d72-6415-4299-b114-3de7bde61067.pdf?trk=public_profile_see-credential" target="_blank">
              <TbFileDownload className='w-5 h-4 md:w-8 md:h-6 text-gray-500' />
            </Link>
          </div>
        </div>
        <div className="flex">
          <div className="flex items-center mx-auto mt-10">
            ...
            <Link to="https://udemy-certificate.s3.amazonaws.com/pdf/UC-f23a5752-30a5-4f45-9e5d-284238eab07d.pdf?trk=public_profile_see-credential" target="_blank">
              <TbFileDownload className='w-5 h-4 md:w-8 md:h-6 text-gray-500' />
            </Link>
          </div>
        </div>
        <div className="flex">
          <div className="flex items-center mx-auto mt-10">
            ...
            <Link to="https://udemy-certificate.s3.amazonaws.com/pdf/UC-9bea2790-1bf7-4ccd-90e9-8dd60f2a2f45.pdf?trk=public_profile_see-credential" target="_blank">
              <TbFileDownload className='w-5 h-4 md:w-8 md:h-6 text-gray-500' />
            </Link>
          </div>
        </div>
        <div className="flex">
          <div className="flex items-center mx-auto mt-10">
            ...
            <Link to="https://udemy-certificate.s3.amazonaws.com/pdf/UC-8ab2c223-1f55-4e01-973e-90cb243a2a67.pdf?trk=public_profile_see-credential" target="_blank">
              <TbFileDownload className='w-5 h-4 md:w-8 md:h-6 text-gray-500' />
            </Link>
          </div>
        </div>
        <div className="flex">
          <div className="flex items-center mx-auto mt-10">
            ...
            <Link to="https://udemy-certificate.s3.amazonaws.com/pdf/UC-b69979d5-eb7a-489c-ac9b-5edf5460fdb2.pdf?trk=public_profile_see-credential" target="_blank">
              <TbFileDownload className='w-5 h-4 md:w-8 md:h-6 text-gray-500' />
            </Link>
          </div>
        </div>
        <div className="flex">
          <div className="flex items-center mx-auto mt-10">
            ...
            <Link to="https://udemy-certificate.s3.amazonaws.com/pdf/UC-35f871a3-03a6-4ff1-8461-40a467676d3a.pdf?trk=public_profile_see-credential" target="_blank">
              <TbFileDownload className='w-5 h-4 md:w-8 md:h-6 text-gray-500' />
            </Link>
          </div>
        </div>
