    ...
    <>
      <div className="col-span-4 sm:col-span-9">
        <div className="shadow rounded-lg p-6">
          <h2 className="title-about mb-4 text-4xl font-extrabold leading-10 tracking-tight sm:text-xl md:text-2xl lg:text-4xl sm:leading-none text-blue-500 text-center mt-14">About Me</h2>
